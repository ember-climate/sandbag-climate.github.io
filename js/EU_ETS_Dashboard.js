...
function createSurplusMapWelcomeDialog(){
    if(surplus_map_opened_for_the_first_time){
        suplus_map_opened_for_the_first_time = false;

        //creating welcome dialog
        surplusMapViewDialog = L.control.dialog({size: [300,180], anchor: [80,80]}).setContent("<h4>Welcome to the Surplus Map View!</h4><p>Please be aware that the surplus value is calculated as follows: <br><strong><i>Surplus = Free Allocation + Offsets(2008-2012) - Emissions</i></strong>").addTo(installations_map);                   
    } 
}
